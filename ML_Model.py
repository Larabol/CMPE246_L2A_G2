...
class MLModelScript:
    def __init__(self, input_file):
        ...
        self.min_voltage = 42.0 ## Change based off our project
        self.max_voltage = 54.6 ## Change based off our project
        self.max_current = 20.0 ## Change based off our project
        self.max_temperature = 60.0 ## Change based off our project
